...
public class RegisterForm extends BaseObservable {
    ...
    public boolean isValid() {
        boolean valid = isEmailValid(false) && isPasswordValid(false) && isUsernameValid(false);
    ...
    public boolean isUsernameValid(boolean setMessage) {
        String username = fields.getPassword();
